...
const MiddleEsternPage = () => {
  ...
  useEffect(() => {
    ...
    const startIndex = Math.max(0, Math.floor(totalItems / 2) - 8);
  ...
  return (
    ...
    <div className='flex flex-col items-center'>
      <div className='text-center mb-6'>
        <h2 className='text-[30px] uppercase text-gray-900/90 my-6'>Middle Estern</h2>
...
export default MiddleEsternPage;
