...
const HomeFragrancePage = () => {
  ...
  useEffect(() => {
    ...
    const startIndex = Math.max(0, Math.floor(totalItems / 2) - 15);
  ...
  return (
    ...
    <div className='flex flex-col items-center'>
      <div className='text-center mb-6'>
        <h2 className='text-[30px] uppercase text-gray-900/90 my-6'>Home Fragrance</h2>
...
export default HomeFragrancePage;
